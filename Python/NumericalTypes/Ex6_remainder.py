...
days_to_completion = 212/8

print("It will take exactly",days_to_completion, "to complete the update")

days_to_completion = (212//8) + 1
print("Please give the team", days_to_completion, "days")
